...
/* GPIO-based I2C definitions */
#define GPIO_I2C4_SDA			GPIO_AP_SDA_18V
#define GPIO_I2C4_SCL			GPIO_AP_SCL_18V

#define GPIO_I2C5_SDA			GPIO_AP_SDA_28V
#define GPIO_I2C5_SCL			GPIO_AP_SCL_28V

#define GPIO_I2C6_SDA			GPIO_AP_PMIC_SDA
#define GPIO_I2C6_SCL			GPIO_AP_PMIC_SCL

#define GPIO_I2C7_SDA			GPIO_USB_SDA_28V
#define GPIO_I2C7_SCL			GPIO_USB_SCL_28V

/* I2C8 is used for the SI4709 on the i9000, unused on SGS4G */

#define GPIO_I2C9_SDA			FUEL_SDA_18V
#define GPIO_I2C9_SCL			FUEL_SCL_18V

#define GPIO_I2C10_SDA			_3_TOUCH_SDA_28V
#define GPIO_I2C10_SCL			_3_TOUCH_SCL_28V
#define GPIO_I2C10_UDELAY		0

#define GPIO_I2C11_SDA			GPIO_ALS_SDA_28V
#define GPIO_I2C11_SCL			GPIO_ALS_SCL_28V

#define GPIO_I2C12_SDA			GPIO_MSENSE_SDA_28V
#define GPIO_I2C12_SCL			GPIO_MSENSE_SCL_28V
